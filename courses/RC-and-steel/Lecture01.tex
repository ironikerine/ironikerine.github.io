...
\textbf{사용재료에 의한 분류}: 구조체에 사용되는 재료는 구성요소로서의 적절한 형상, 치수, 접합법 등을 가지며 그 결과, 구조체 전체로서도 각 재료의 특성이 반영됨. 크게는 목조, \alert{벽돌조}, \alert{철골조}, \alert{철근콘크리트조}, 철골철근콘크리트조, 보강콘크리트블럭조로 구분됨.
