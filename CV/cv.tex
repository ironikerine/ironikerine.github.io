...
\subsection*{Books}
\years{2023} 한국강구조학회. (2023). 강구조물~성능기반~내진설계~및~평가지침. 한국강구조학회.

\subsection*{Journal articles (International)}

\noindent
\years{2024}
Jun, S.-C., Lee, C.-H., \& Kim, S.-Y. (2024). Vibration mitigation of modular structures supported by ground-floor piloti. Journal of Constructional Steel Research, 222, 108965.\\
Jang, H.-L., Han, C.-H., Kim, R.-H., Park, D.-Y., \& Kim, S.-Y. (2024). Experimental and Numerical Analysis of a Temporary Bridge Connector Consisting of an Upper Bearing Block–Lower Pin Configuration. Applied Sciences, 14(5), Article 5.\\
\years{2022}
Joo, H., Lee, S., Kang, S.-J., \& Kim, S.-Y. (2022). Vacant House Characteristics by Use Area and Their Application to Sustainable Community. Applied Sciences, 12(21), Article 21. \\
Lee, C.-H., Park, J.-H., Kim, S.-Y., Kim, D.-K., \& Jun, S.-C. (2022). Structural damage potentials and design implications of 2016 Gyeongju and 2017 Pohang earthquakes in Korea. Earthquakes and Structures, 22(3), 305–318.\\
\years{2021}Kim, S.-Y., \& Lee, C.-H. (2021). Nondimensionalized Bouc–Wen model with structural degradation for Kalman filter–based real-time monitoring. Engineering Structures, 244, 112764.
\\
\years{2020}Kim, S.-Y., \& Kim, J. (2020). Constrained Unscented Kalman Filter for Structural Identification of Bouc–Wen Hysteretic System. Advances in Civil Engineering, 2020, 1–11.
\\
Kim, S.-Y., \& Lee, C.-H. (2020). Analysis and Optimization of Multiple Tuned Mass Dampers with Coulomb Dry Friction. Engineering Structures, 209, 110011.
\\
\years{2019}Lee, C.-H., Jung, J.-H., \& Kim, S.-Y. (2019). Cyclic Seismic Performance of Weak-Axis RBS Welded Steel Moment Connections. International Journal of Steel Structures, 19(5), 1592–1604.
\\
Kim, S.-Y., \& Lee, C.-H. (2019). Description of Asymmetric Hysteretic Behavior Based on the Bouc-Wen Model and Piecewise Linear Strength-Degradation Functions. Engineering Structures, 181, 181–191.
\\
Kim, S.-Y., \& Lee, C.-H. (2019). Peak response of frictional tuned mass dampers optimally designed to white noise base acceleration. Mechanical Systems and Signal Processing, 117, 319–332.
\\
\years{2018}Kim, S.-Y., \& Lee, C.-H. (2018). Optimum design of linear multiple tuned mass dampers subjected to white-noise base acceleration considering practical configurations. Engineering Structures, 171, 516–528.
\\
\years{2017}Kim, S.-Y., \& Lee, C.-H. (2017). Seismic Retrofit of Welded Steel Moment Connections with Highly Composite Floor Slabs. Journal of Constructional Steel Research, 139, 62–68.
\\
\years{2016}Kim, S.-Y., Lee, C.-H., \& Kim, N.-E. (2016). Effective impulse model for prediction of vibration response of high-frequency steel staircases. Journal of Constructional Steel Research, 126, 129–138.
\\
Cheol-Ho Lee, Jong-Hyun Jung, Sung-Yong Kim, Jeong-Jae Kim (2016), Investigation of Composite Slab Effect on Seismic Performance of Steel Moment Connections, \emph{Journal of Constructional Steel Research}, 117, pp.91-100.\\
Cheol-Ho Lee, Thomas H.-K Kang, Sung-Yong Kim, Kiyong Kang (2016), Strain Compatibility Method of the Design of Short Rectangular Concrete-Filled Tube Columns under Eccentric Axial Loads, \emph{Construction and Building Materials}, 121, pp.143-153.\\
\subsection*{Journal articles (Domestic)}
\vspace{5mm}\\
\years{2024}An, J.-H., Kim, S.-Y., \& Park, G.-S. (2024). Stiffness-Based Seismic Design of Access Floor System with Multi-Span Continuous Stringers. Journal of Korean Society of Steel Construction, 36(3), 175–185.\\
\years{2017}Lee, C.-H., \& Kim, S.-Y. (2017). Seismic Retrofit of Welded Steel Moment Connections Considering the Presence of Composite Floor Slabs. Journal of Korean Society of Steel Construction, 29(1), 25–36.\\
